...
/obj/structure/falsewall/titanium
	...
	smooth = SMOOTH_MORE
	canSmoothWith = list(/turf/closed/wall/mineral/titanium, /obj/machinery/door/airlock)
...
/obj/structure/falsewall/plastitanium
	...
	smooth = SMOOTH_MORE
	canSmoothWith = list(/turf/closed/wall/mineral/plastitanium, /obj/machinery/door/airlock)
